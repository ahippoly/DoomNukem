...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/07/07 23:58:34 by ahippoly          #+#    #+#             */
/*   Updated: 2020/07/08 00:09:45 by ahippoly         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "proto_global.h"

static int		check_intersect_with_all_wall_point(t_point p1, t_point p2,
		t_env *env)
{
	int		i;
	t_wall	checked_wall;
...
int				add_wall(t_point p1, t_point p2, t_env *env)
{
	...
	{
		success = 1;
		env->wall_list[env->wall_count] = create_wall(p1, p2,
			env->wall_count, env);
		env->wall_count++;
	}
	else
